...
Sending transactions using gRPC and REST requires some additional steps: generating the transaction, signing it, and finally broadcasting it. Read about [Creating transactions](../develop/tech-concepts/02_creating_transactions.md). 
