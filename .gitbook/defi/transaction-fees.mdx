...
More information regarding gas in Cosmos SDK can be found [here](https://github.com/cosmos/cosmos-sdk/blob/main/docs/docs/learn/beginner/04-gas-fees.md).
...
The Cosmos SDK [`AnteHandler`](https://docs.cosmos.network/sdk/latest/modules/auth) performs basic checks prior to transaction execution. These checks are usually signature verification, transaction field validation, transaction fees, etc.
