...
* Example: Address `inj1a` enters epoch 22 prequalified from maintaining eligibility in epoch 21. Suppose the cumulative maker volume of [eligible markets](./eligible-markets/) in epoch 22 totals $200M. Then `inj1a` must contribute at least $500,000 of the $200M in [eligible markets](./eligible-markets/) by the end of epoch 22 to maintain automatic eligibility for epoch 23.
...
<iframe src="https://trading.injective.network/program/liquidity/eligibility" className="w-full h-96 rounded-xl"></iframe>
