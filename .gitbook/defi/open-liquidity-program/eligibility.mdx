...
<Frame hint="The OLP dashboard can be used to track current and future epoch reward eligibility." caption="OLP dashboard">
  <iframe
    className="w-full h-96 rounded-xl"
    src="https://trading.injective.network/program/liquidity/eligibility"
    title="OLP Dashboard"
