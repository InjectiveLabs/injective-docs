...
**Each institutional liquidity provider** **will receive rewards based on their proportional**[ $$TS$$ ](/defi/open-liquidity-program/scoring#total-score)**within the market, subject to governance approval.**
