...
description: "OLP Reward Allocations"
updatedAt: "2026-06-25"
---

## Market Reward Allocations

Rewards are allocated to [eligible markets](https://trading.injective.network/program/liquidity) in three different methods :
