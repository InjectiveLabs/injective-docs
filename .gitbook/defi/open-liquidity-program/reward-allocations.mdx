...
13.33% of INJ rewards will be preallocated to each of the BTC/USDT PERP market, ETH/USDT PERP market, and INJ/USDT PERP market, and 5% will be preallocated to the INJ/USDT spot market. The remaining INJ for each epoch will be allocated to each remaining eligible market with a minimum allocation of 100 INJ.
...
<tr>
<td>Other Eligible Markets</td>
<td align="right">Formula-based allocation</td>
</tr>
</tbody>
</table>
