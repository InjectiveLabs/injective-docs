---
title: "Introduction"
description: "Injective's market-maker incentive program, the Open Liquidity Program (OLP): How epochs, scoring, fee tiers, and reward disbursements work."
...
Rewards for OLP are disbursed in the form of INJ, Injective's native utility and governance token. Currently, **30,000 INJ** can be earned by eligible participants during each epoch (28 day period). Starting with epoch 61, the reward for each epoch will be **25,000 INJ**.
