...
title: Scoring Formula/Methodology
---
...
where $$LS_{epoch}$$ is the MM's [Liquidity Score](./scoring/#liquidity-score) in the market in the epoch, $$Uptime_{Epoch}$$is the MM's [Uptime score](./scoring/#uptime-score) in the market in the epoch, and $$Volume_{epoch}$$ is the MM's total volume (maker and taker) in the market in the epoch.

<Callout icon="info" color="#07C1FF" iconType="regular">
$$a$$, $$b$$, and $$c$$ are exponent [parameters](./formula-parameters/) that weight the different components of the formula.
</Callout>
...
<Callout icon="info" color="#07C1FF" iconType="regular">
For the current values of $$MinDepth$$ and $$MaxSpread$$, see the [Formula Parameters page](./formula-parameters/).
</Callout>
...
<Callout icon="info" color="#07C1FF" iconType="regular">
For information on individual reward calculations each epoch, see the [Reward Allocations page](./reward-allocations/).
</Callout>
