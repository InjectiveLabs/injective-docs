...
```
curl -s -X POST https://glp.rest.injective.network/injective_dmm_v2.InjectiveDmmV2/GetEpochs
```

> Rewards per Address:

```
curl -s -d '{"epochId":"epoch_231128_231225"}' -X POST https://glp.rest.injective.network/injective_dmm_v2.InjectiveDmmV2/GetEpochScores
```

> Rewards in a Market:

```
curl -X POST -d '{"epochId": "epoch_240123_240219", "marketId":"0x4ca0f92fc28be0c9761326016b5a1a2177dd6375558365116b5bdda9abc229ce", "page": {"perPage": 200}}' https://glp.rest.injective.network/injective_dmm_v2.InjectiveDmmV2/GetTotalScores
```

> Snapshots for Address:

```
curl -X POST -d '{"epochId": "epoch_240123_240219", "accountAddress": "<INSERT ADDRESS>", "marketId":"0x4ca0f92fc28be0c9761326016b5a1a2177dd6375558365116b5bdda9abc229ce", "page": {"perPage": 200}}' https://glp.rest.injective.network/injective_dmm_v2.InjectiveDmmV2/GetTotalScoresHistory
```