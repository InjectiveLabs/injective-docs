...
title: Reward Allocations (Legacy)
hidden: true
---

## Market Reward Allocations

Rewards are allocated to [eligible markets](/defi/open-liquidity-program/eligible-markets) in two different methods:
...
For more information on $$TAR$$ each epoch, see the [Reward Pool](/defi/open-liquidity-program/rewards) page.
</Callout>
...
Any reward allocations that exceed the cap will be redistributed amongst the other eligible markets according to the [dynamic allocation formula](/defi/open-liquidity-program/reward-allocations-legacy#dynamic-market-reward-allocations).
...
**Each** [**MM**](#user-content-fn-1)[^1] **will receive rewards based on the** [**MM**](#user-content-fn-1)[^1]**’s proportional**[ $$TS$$ ](/defi/open-liquidity-program/scoring#total-score)**within the market, subject to governance approval.**
