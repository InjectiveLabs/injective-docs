...
For more information on $$TAR$$ each epoch, see the [Reward Pool](./rewards/) page.
</Callout>
...
Any reward allocations that exceed the cap will be redistributed amongst the other eligible markets according to the [dynamic allocation formula](./reward-allocations-legacy/#dynamic-market-reward-allocations).
...
**Each** [**MM**](#user-content-fn-3)[^3] **will receive rewards based on the** [**MM**](#user-content-fn-4)[^4]**’s proportional**[ $$TS$$ ](./scoring/#total-score)**within the market, subject to governance approval.**&#x20;
