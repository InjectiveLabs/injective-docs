...
**Each** [**MM**](#user-content-fn-1)[^1] **will receive rewards based on the** [**MM**](#user-content-fn-1)[^1]**’s proportional**[ $$TS$$ ](./scoring/#total-score)**within the market, subject to governance approval.**
