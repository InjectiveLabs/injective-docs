...
Using this figure, a _Cumulative Price_ is accumulated throughout the hour. As each trade occurs, the current _Premium_ is multiplied by the time passed since the last update:
