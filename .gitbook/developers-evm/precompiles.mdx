...
For example, our [MultiVM Token Standard (MTS)](./multivm-token-standard/) model, which ensures unified token balances across native and EVM environments, is heavily reliant on the **Bank Precompile**.
...
| ---------------------------------- | ----------------------------- | ----------- |
| [Bank](./bank-precompile/)         | Token Management              | 0x64        |
| [Exchange](./exchange-precompile/) | On-chain Order Book           | 0x65        |
