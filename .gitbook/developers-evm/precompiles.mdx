...
title: Precompiles
description: >-
    Precompiles that expose Injective-specific modules (exchange, staking, governance) to the Injective EVM,
    which allows Solidity smart contracts to have direct access to Injective's powerful native modules.
...
* [Exchange Precompile Demo](https://github.com/InjectiveLabs/solidity-contracts/tree/master/demos/exchange-direct)
...
| [Swap](/developers-evm/swap-precompile)         | Native spot swaps against the orderbook (v1.20.4+) | `0x68`      |
