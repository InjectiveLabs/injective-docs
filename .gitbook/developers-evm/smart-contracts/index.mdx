...
description: >-
    Step-by-step guide to creating a EVM smart contracts on Injective using
    Hardhat or Foundry development frameworks.
    Including set up, compilation, testing, deploying, verifying, and interacting
