...
目前，唯一支持运行预构建 `injectived` CLI 的平台是 Linux x86_64。预构建二进制文件可在 [Injective GitHub Releases 页面](https://github.com/InjectiveLabs/injective-chain-releases/releases)获取。
