...
对于比较公共 Injective RPC 提供商的集成方，[OpenChainBench](https://openchainbench.com/benchmarks/injective-rpc) 发布了 Tendermint `status` 方法的持续延迟基准，涵盖 Injective Foundation 端点和社区提供商（PublicNode、Polkachu、LavenderFive）。探测每 60 秒从阿姆斯特丹、弗吉尼亚和新加坡发起。

来源和方法论：[github.com/ChainBench/openchainbench](https://github.com/ChainBench/openchainbench)。
