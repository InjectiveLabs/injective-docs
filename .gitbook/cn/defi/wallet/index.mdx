...
Injective 钱包允许你监控你在 Injective 上的资产。资产可以是 Injective 上的原生 token，也可以是从 Ethereum、Solana、Polygon 和各种支持 IBC 的链桥接过来的资产。参见 [Injective Hub Staking 指南](https://injective.com/blog/injective-hub/)
...
如上所述，基于 Ethereum 的钱包可用于与 Injective 交互。目前，Injective 支持最流行的基于 Ethereum 的钱包，包括：
...
目前，[Ninji Wallet](https://ninji.xyz/) 是唯一的 Injective 原生钱包。这种钱包专门为与更广泛的 Injective 生态系统协同而构建。

#### 基于 CEX 的钱包

还有几个由中心化交易所 (CEX) 开发的钱包现在支持 Injective。如果你是这些 CEX 的活跃用户，使用他们的钱包可以提供更无缝的 web3 体验。目前，支持 Injective 的基于 CEX 的钱包有：
