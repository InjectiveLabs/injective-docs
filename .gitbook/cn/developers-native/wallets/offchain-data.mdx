...
在本页面，我们将提供如何根据 Cosmos 上的 [ADR-036](https://docs.cosmos.network/main/build/architecture/adr-036-arbitrary-signature) 规范签署和验证任意数据的示例。

<Callout icon="info" color="#07C1FF" iconType="regular">
您可以使用 `@injectivelabs/sdk-ts` 中的 `generateArbitrarySignDoc` 函数生成 ADR-36 兼容的 `signDoc`。然后您可以使用它在浏览器钱包或 CLI 环境中进行签名/验证。请确保您使用的是最新的包版本。
</Callout>
