...
description: >-
  ...
  Learn what makes Injective different, how performant it is, frequently asked questions,
  what you can do, how to get started, and where to get help.
...
<script type="application/ld+json">{JSON.stringify({
  ...
  "@type": "Organization",
  "name": "Injective Labs",
  "alternateName": "Injective",
  "url": "https://injective.com",
  "description": "Injective Labs is the core development team behind Injective: A high-performance Layer-1 blockchain optimized for decentralized finance applications, offering on-chain orderbooks, MEV-resistant transaction ordering, cross-chain interoperability, EVM smart contracts, and AI-powered builder tools.",
  "foundingDate": "2018",
  "sameAs": [
    "https://x.com/injective",
    "https://github.com/InjectiveLabs",
    "https://www.linkedin.com/company/injective-labs/",
    "https://youtube.com/@Injective_",
    "https://www.crunchbase.com/organization/injective-labs",
    "https://en.wikipedia.org/wiki/Injective_(blockchain)"
  ],
  "contactPoint": {
    "@type": "ContactPoint",
...
<script type="application/ld+json">{JSON.stringify({
  ...
  "@type": "WebSite",
  "name": "Injective Docs",
  "alternateName": "Injective Documentation",
  "url": "https://docs.injective.network",
  "description": "Official technical documentation for Injective: A high-performance, interoperable Layer-1 blockchain for building decentralized finance applications.",
  "inLanguage": "en",
  "publisher": {
    "@type": "Organization",
    "name": "Injective Labs",
  ...
  "potentialAction": {
    ...
    "target": {
      "@type": "EntryPoint",
      "urlTemplate": "https://docs.injective.network/?search={search_term}"
    },
