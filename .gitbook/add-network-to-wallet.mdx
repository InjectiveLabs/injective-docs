  ...
  <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
    <button
      ...
      onClick={(event) => {
        ...
        providerPromise.then((provider) => {
          if (!provider) { finish("Wallet not found", false); alert("Please install MetaMask."); return false; }
          ...
          .catch((error) => {
            ...
            label.textContent = getErrorCode(error) === 4001 ? "Request cancelled" : "Try again";
    ...
    <button
      ...
      onClick={(event) => {
        ...
        providerPromise.then((provider) => {
          if (!provider) { finish("Wallet not found", false); alert("Please install Trust Wallet."); return false; }
          return provider.request({ method: "eth_requestAccounts" })
          .then(() => provider.request({
            method: "wallet_switchEthereumChain",
            params: [{ chainId: "0x6f0" }]
