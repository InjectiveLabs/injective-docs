...
<div style={{ border: "1px solid rgba(77,61,255,0.22)", borderRadius: "16px", padding: "16px 18px", background: "rgba(128,128,128,0.06)", marginBottom: "14px" }}>
  ...
  <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
    <button
      ...
      style={{ display: "inline-flex", alignItems: "center", gap: "9px", padding: "9px 16px", borderRadius: "11px", border: "1px solid rgba(128,128,128,0.28)", background: "transparent", color: "inherit", fontWeight: 600, fontSize: "14px", cursor: "pointer", minWidth: "150px" }}
    >
      <img src="/img/SVG_MetaMask_Icon_Color.svg" alt="MetaMask" width="22" height="22" style={{ flexShrink: 0 }} />
      Add to MetaMask
    </button>
    <button
      type="button"
      ...
      style={{ display: "inline-flex", alignItems: "center", gap: "9px", padding: "9px 16px", borderRadius: "11px", border: "1px solid rgba(128,128,128,0.28)", background: "transparent", color: "inherit", fontWeight: 600, fontSize: "14px", cursor: "pointer", minWidth: "150px" }}
    >
      <img src="https://avatars.githubusercontent.com/u/76786120?s=200&v=4" alt="SubWallet" width="22" height="22" style={{ flexShrink: 0, borderRadius: "5px" }} />
      Add to SubWallet
    </button>
  </div>
</div>
...
<div style={{ border: "1px solid rgba(77,61,255,0.22)", borderRadius: "16px", padding: "16px 18px", background: "rgba(128,128,128,0.06)", marginBottom: "14px" }}>
  ...
  <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
    <button
      ...
      style={{ display: "inline-flex", alignItems: "center", gap: "9px", padding: "9px 16px", borderRadius: "11px", border: "1px solid rgba(128,128,128,0.28)", background: "transparent", color: "inherit", fontWeight: 600, fontSize: "14px", cursor: "pointer", minWidth: "150px" }}
    >
      <img src="/img/Keplr_logo_ver.1.3_2%20Light.png" alt="Keplr" width="22" height="22" style={{ flexShrink: 0, borderRadius: "5px" }} />
      Add to Keplr
    </button>
    <button
      type="button"
      ...
      style={{ display: "inline-flex", alignItems: "center", gap: "9px", padding: "9px 16px", borderRadius: "11px", border: "1px solid rgba(128,128,128,0.28)", background: "transparent", color: "inherit", fontWeight: 600, fontSize: "14px", cursor: "pointer", minWidth: "150px" }}
    >
      <img src="/img/6614b644f965e11764db3535_leap.svg" alt="Leap" width="22" height="22" style={{ flexShrink: 0 }} />
      Add to Leap
    </button>
  </div>
</div>
