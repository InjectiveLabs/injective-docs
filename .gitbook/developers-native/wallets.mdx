...
| Topic                                                   | Description                                                     |
| ------------------------------------------------------- | --------------------------------------------------------------- |
| [Accounts on Injective](./accounts/)             | Accounts/Wallets definition on Injective                        |
| [Wallet Connections](./connections/)             | Connecting directly using Metamask or Keplr                     |
| [Wallet Strategy](./strategy/)            | Using the WalletStrategy to connect using different wallets     |
| [Offchain (Arbitrary) Data](./offchain-data/) | Signing and verifying data offchain using the ADR-036 by Cosmos |
