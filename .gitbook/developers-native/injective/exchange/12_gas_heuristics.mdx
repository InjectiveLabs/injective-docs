...
**Live on testnet.** These gas heuristics require `fixed_gas_enabled` to be set to `true` in the Exchange module params. This is currently enabled on testnet and will be activated on mainnet via a forthcoming governance params proposal.
</Callout>
...
|-------------------------------------------------|------------------------------|
| MsgCreateDerivativeLimitOrder                   | 330,000                      |
| MsgCreateDerivativeLimitOrder (post-only)       | 370,000                      |
| MsgCreateDerivativeMarketOrder                  | 310,000                      |
| MsgCancelDerivativeOrder                        | 200,000                      |
| MsgCreateSpotLimitOrder                         | 300,000                      |
| MsgCreateSpotLimitOrder (post-only)             | 330,000                      |
| MsgCreateSpotMarketOrder                        | 300,000                      |
| MsgCancelSpotOrder                              | 185,000                      |
| MsgCreateBinaryOptionsLimitOrder                | 330,000                      |
| MsgCreateBinaryOptionsLimitOrder (post-only)    | 370,000                      |
| MsgCreateBinaryOptionsMarketOrder               | 310,000                      |
| MsgCancelBinaryOptionsOrder                     | 200,000                      |
| MsgDeposit                                      | 330,000                      |
| MsgWithdrawGas                                  | 320,000                      |
| MsgSubaccountTransferGas                        | 220,000                      |
| MsgExternalTransferGas                          | 300,000                      |
| MsgIncreasePositionMarginGas                    | 185,000                      |
| MsgDecreasePositionMarginGas                    | 200,000                      |
