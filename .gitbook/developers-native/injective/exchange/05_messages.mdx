...
created/modified state objects specified by each message are defined within the [State Transitions](/developers-native/injective/exchange/04_state_transitions)
section.
