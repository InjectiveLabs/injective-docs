...
Here is an example taken from the Injective [erc20 module](/developers-native/injective/erc20) that shows how the `EVMHooks` supports a contract calling a native module to convert ERC-20 Tokens into Cosmos native Coins. Following the steps from above.
