...
`Singer` confirmation for a particular validator set. See [oracle messages](04_messages/#ValsetConfirm)
...
`Singer` confirmation for a particular token batch. See [oracle messages](04_messages/#ConfirmBatch)
