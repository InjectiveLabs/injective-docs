---
title: Injective Block SDK Integration
updatedAt: "2025-12-27"
---

# Injective Block SDK Integration

Injective integrates the [Block SDK](https://github.com/skip-mev/block-sdk). Our solution leverages a multi‑lane mempool that separates transactions into four distinct lanes:
