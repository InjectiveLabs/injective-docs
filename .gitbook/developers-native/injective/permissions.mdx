...
1. [Concepts](./permissions/01_concepts/)
2. [State](./permissions/02_state/)
3. [State Transitions](./permissions/03_state_transitions/)
4. [How to Launch Permissioned Assets](./permissions/04_launch_permissioned_asset/)
5. [Error Codes](./permissions/99_errors/)
