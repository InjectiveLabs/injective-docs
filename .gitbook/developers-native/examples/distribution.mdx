...
The `distribution` module is extended from the cosmos sdk [distribution module](https://docs.cosmos.network/sdk/latest/modules/distribution), where delegator can withdraw their staking rewards from the validator.
