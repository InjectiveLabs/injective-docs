...
the block for a given index in the bit-array.
...
Ref: [https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/slashing/v1beta1/slashing.proto#L13-L35](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/slashing/v1beta1/slashing.proto#L13-L35)
...
Ref: [https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/slashing/v1beta1/slashing.proto#L37-L59](https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/slashing/v1beta1/slashing.proto#L37-L59)
...
| `SlashFractionDoubleSign` | `string (dec)`   | `"0.000000000000000000"` |
| `SlashFractionDowntime`   | `string (dec)`   | `"0.000000000000000000"` |
