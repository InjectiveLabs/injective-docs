...
Add a genesis account to `genesis.json`. Learn more [here](https://github.com/cosmos/cosmos-sdk/blob/main/docs/docs/user/run-node/01-run-node.md#adding-genesis-accounts).
