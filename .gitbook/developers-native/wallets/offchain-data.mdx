---
title: Offchain (Arbitrary) Data
updatedAt: "2025-11-28"
---

On this page, we'll provide an example of how to sign and verify arbitrary data as per the [ADR-036](https://github.com/cosmos/cosmos-sdk/blob/main/docs/architecture/adr-036-arbitrary-signature.md) specification on Cosmos.
