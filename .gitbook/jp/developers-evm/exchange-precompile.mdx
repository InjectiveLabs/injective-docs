...
この`ExchangeDemo`スマートコントラクトのビルド、デプロイ、インタラクション方法（サブアカウントのセットアップと資金供給を含む）の詳細な手順については、[solidity-contracts](https://github.com/InjectiveLabs/solidity-contracts/tree/master/demos/exchange-direct)リポジトリの包括的なデモを参照してください。
