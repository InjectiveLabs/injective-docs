...
`distribution`モジュールはCosmos SDKの[distributionモジュール](https://docs.cosmos.network/sdk/latest/modules/distribution)を拡張したもので、delegatorはバリデータからステーキング報酬を引き出すことができます。
