...
<CardGroup cols={3}>
  <Card title="Upgrades" icon="arrow-up" href="https://chain.injective.network/upgrades">
    Track network upgrades, governance proposals, and activation timelines.
  </Card>
  <Card title="Snapshots" icon="database" href="https://chain.injective.network/snapshots">
    Pruned and archival snapshots for fast node sync.
  </Card>
  <Card title="RPCs & Endpoints" icon="server" href="https://chain.injective.network/rpcs">
...
<CardGroup cols={2}>
  ...
  <Card title="Testnet Resources" icon="flask-vial" href="https://chain.injective.network/testnet">
    Live testnet version, faucets, explorers, CCTP contracts, RPCs, and binary downloads.
  </Card>
</CardGroup>
