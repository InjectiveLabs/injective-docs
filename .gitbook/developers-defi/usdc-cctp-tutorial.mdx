...
It does so by burning it on the source chain
...
[USDC CCTP demo](https://github.com/Ninja-Labs-Devs/USDC-CCTP-Template) repository.

Clone the repository and install its dependencies:

```shell
git clone https://github.com/Ninja-Labs-Devs/USDC-CCTP-Template
