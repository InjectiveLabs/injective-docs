...
The Injective Chain will undergo a scheduled enhancement upgrade.

The following is a short summary of the upgrade steps:

1. Vote and wait till the node panics at block height **154983000**.
2. Backing up configs, data, and keys used for running the Injective Chain.
3. Install the [1.18.0](https://github.com/InjectiveLabs/injective-chain-releases/releases/tag/v1.18.0) binaries.
...
3. Download and install the `injective-chain` release for `1.18.0`:
    ...
    ```bash
    wget https://github.com/InjectiveLabs/injective-chain-releases/releases/download/v1.18.0/linux-amd64.zip
