...
1. **Never run two nodes with the same `priv_validator_key.json` simultaneously.** This causes double-signing, a 5% slash, and permanent tombstoning. The validator can never rejoin the active set.
