...
Next, proceed to set up your [Ethereum Bridge Relayer](./validator-mainnet/peggo/). This is a necessary step to prevent your validator from being slashed. You should do this immediately after setting up your validator.
