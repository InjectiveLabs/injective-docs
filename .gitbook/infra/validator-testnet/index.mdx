...
description: >-
  Step-by-step guide to setting up and running a validator node on Injective testnet.
  Includes hardware requirements, key management, and commission configuration.
