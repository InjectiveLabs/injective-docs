...
Learn more about Keyring setup [here](https://github.com/cosmos/cosmos-sdk/blob/main/docs/docs/user/run-node/00-keyring.md).
...
You can also read more about the Cosmos Keyring setup [here](https://github.com/cosmos/cosmos-sdk/blob/main/docs/docs/user/run-node/00-keyring.md).
...
You can verify successful registration by checking for your Validator's mapped Ethereum address on https://sentry.lcd.testnet.injective.network/peggy/v1/valset/current.
