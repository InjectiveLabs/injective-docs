...
<Note>
If the upgrade fails or a sentry node becomes corrupted, see the [Snapshots page](https://chain.injective.network/snapshots) for options to resync your node from a fresh snapshot.
</Note>
