...
| Snapshot Dir | Height Range    | Injective Version |
| ------------ | --------------- | ----------------- |
| `/0073`      |   0 – 73M       | v1.12.1           |
| `/6068`      |   60M – 68M     | v1.12.1           |
| `/7380`      |   73M – 80M     | v1.12.1           |
| `/8088`      |   80M – 88M     | v1.13.3           |
| `/8896`      |   88M – 96M     | v1.13.3           |
| `/8898`      |   88M – 98M     | v1.13.3           |
| `/98106`     |   98M – 106M    | v1.13.3           |
| `/98107`     |   98M – 107M    | v1.14.0           |
| `/66101`     |   66M – 101M    | v1.14.0           |
| `/105116`    |   105M – 116M   | v1.15.0           |


These segments are stiched together via gateway which is an aggregator proxy that routes queries to the appropriate node based on block range
...
```
aws cp s3://injective-snapshots/mainnet/subnode/<SNAPSHOT_DIR> $INJ_HOME
```
...
```
#### 4. Disable prunning in your app.toml file and block p2p and set the log level to error in your config.toml files.
