...
도움이 되는 기초 읽기 자료: [Gas Metering](https://docs.cosmos.network/sdk/latest/learn/concepts/context-gas-events#gas-metering), [Auth Module Gas & Fees](https://docs.cosmos.network/sdk/latest/modules/auth/auth#gas-&-fees)
</Callout>

<Callout icon="info" color="#22C55E" iconType="regular">
**Exchange 모듈 가스 휴리스틱:** exchange 모듈의 메시지 유형별 상세 가스 비용(주문 생성, 취소, market 작업)은 [Gas Heuristics 참조](/ko/developers-native/injective/exchange/12_gas_heuristics)를 확인하세요.
</Callout>
...
Cosmos SDK의 가스에 대한 자세한 정보는 [여기](https://github.com/cosmos/cosmos-sdk/blob/main/docs/docs/learn/beginner/04-gas-fees.md)에서 찾을 수 있습니다.
...
Cosmos SDK [`AnteHandler`](https://docs.cosmos.network/sdk/latest/modules/auth)는 트랜잭션 실행 전에 기본 검사를 수행합니다. 이러한 검사는 일반적으로 서명 검증, 트랜잭션 필드 검증, 트랜잭션 수수료 등입니다.
