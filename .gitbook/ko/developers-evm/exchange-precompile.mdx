...
서브계정 설정 및 자금 조달을 포함하여 이 `ExchangeDemo` 스마트 컨트랙트를 빌드, 배포 및 상호작용하는 방법에 대한 자세한 지침은 [solidity-contracts](https://github.com/InjectiveLabs/solidity-contracts/tree/master/demos/exchange-direct) 저장소에서 제공되는 포괄적인 데모를 참조하세요.
