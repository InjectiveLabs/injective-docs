...
이것은 Peggy 메시지 유형에 대한 참조 문서입니다. 코드 참조와 정확한 인수는 [proto 정의](https://github.com/InjectiveLabs/injective-proto/blob/master/all_protos/injective/peggy/v1/msgs.proto)를 참조하세요.
