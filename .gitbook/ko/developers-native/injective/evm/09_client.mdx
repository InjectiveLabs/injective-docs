...
Ethermint에서 지원되는 JSON-RPC 메서드 및 네임스페이스에 대한 개요는 [https://docs.cosmos.network/evm/latest/api-reference/ethereum-json-rpc/index](https://docs.cosmos.network/evm/latest/api-reference/ethereum-json-rpc/index)을 참조하십시오.
