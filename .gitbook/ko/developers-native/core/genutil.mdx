...
`genesis.json`에 genesis 계정을 추가합니다. 자세한 내용은 [여기](https://github.com/cosmos/cosmos-sdk/blob/main/docs/docs/user/run-node/01-run-node.md#adding-genesis-accounts)를 참조하세요.
