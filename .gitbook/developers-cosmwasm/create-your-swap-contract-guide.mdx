---
title: Create your Swap Contract
...
Anyone can instantiate an instance of the swap contract. There is a version of this contract uploaded on Injective mainnet already (code ID 67).
