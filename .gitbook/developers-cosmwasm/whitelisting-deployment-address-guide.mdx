---
title: Whitelisting deployment address
---

Contract upload on Injective mainnet requires governance approval. You can read through the guide to do so in the [mainnet-deployment.md](./mainnet-deployment-guide/ "mention") guide.
