...
This is powerful because it give your AI tools the ability to trade on Injective.
...
[MCP](https://modelcontextprotocol.io/introduction) is an **open standard** that enable
...
| Endpoint | localhost |
| Transport | stdio |
| Available tools | Multiple (see Github) |
...
Once connected, you can ask your AI tool to perform queries and transactions Injective.
