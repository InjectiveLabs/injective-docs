...
- **Skills** -
    ...
    so the above is specific to this contexts.
- **AI engineering IDEs** -
...
How to install and use the [Injective CLI skill](/developers-ai/injective-cli-skill).
...
How to install and use the [Injective EVM Developer skill](/developers-ai/injective-evm-developer-skill).
...
How to install and use the [Injective MCP Servers skill](/developers-ai/injective-mcp-servers-skill).

### Injective Trading Skills

How to install and use the [Injective Trading skills](/developers-ai/injective-trading-skills).
...
How to use the [Injective MCP server](/developers-ai/mcp)
