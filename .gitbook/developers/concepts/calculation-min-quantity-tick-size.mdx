---
title: Market min quantity tick size calculation
---
...
```js
const chainFormat = toHumanReadable(value, baseDecimals)
```
...
```js
const humanReadableFormat = toBigNumber(minQuantityTickSize)
