...
you should check out the guides in [your first EVM dApp](../developers-evm/dapps/).
</Callout>
...
| Topic                                     | Description                 |
| ----------------------------------------- | --------------------------- |
| [Configuring Nuxt](./dapps/configure-nuxt/)     | Configuring Nuxt 3.x + Vite |
| [Configuring React](./dapps/configure-react/)   | Configuring React 18 + Vite |

### dApps

| Topic                                      | Description                                              |
| ------------------------------------------ | -------------------------------------------------------- |
| [DEX](./dapps/example-dex/)                              | Building a decentralized exchange on top of Injective    |
| [Simple Smart Contract](./dapps/example-smart-contract/) | Building a simple smart contract app on top of Injective |
| [Webpack](./dapps/example-webpack/) | Simple HTML example with Webpack and Injective |

{/* 
| [Bridge](./dapps/example-bridge/)                        | Building a simple bridge between Injective and Ethereum  |
*/}
