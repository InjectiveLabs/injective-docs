...
| Topic                                     | Description                 |
| ----------------------------------------- | --------------------------- |
| [Configuring Nuxt](./configure-nuxt/)     | Configuring Nuxt 3.x + Vite |
| [Configuring React](./configure-react/)   | Configuring React 18 + Vite |

### dApps

| Topic                                      | Description                                              |
| ------------------------------------------ | -------------------------------------------------------- |
| [DEX](./example-dex/)                              | Building a decentralized exchange on top of Injective    |
| [Simple Smart Contract](./example-smart-contract/) | Building a simple smart contract app on top of Injective |
| [Webpack](./example-webpack/) | Simple HTML example with Webpack and Injective |

{/* 
| [Bridge](./example-bridge/)                        | Building a simple bridge between Injective and Ethereum  |
*/}
