...
* [Join Mainnet](../../docs/nodes/RunNode/mainnet/)
* [Join Testnet](../../docs/nodes/RunNode/testnet/)
...
:::note The commands above will only work if the default `.injectived` directory is used. For a specific directory, either modify the commands above or manually edit the `genesis.json` file to reflect the changes. :::
